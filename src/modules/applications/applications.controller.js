...
export async function getApplications(req, res, next) {
  try {
    const result = await AppService.getApplications(req.query, req.user);
...
export async function getApplicationStats(req, res, next) {
  try {
    const data = await AppService.getApplicationStats(req.query, req.user);
...
export async function hireApplicant(req, res, next) {
  try {
    const result = await AppService.hireApplicant(req.params.id, req.user);
...
export async function approvePortalAccess(req, res, next) {
  try {
    const data = await AppService.approvePortalAccess(req.params.id, req.user);
    res.json({ success: true, data });
  } catch (err) { next(err); }
}
...
export async function rejectApplication(req, res, next) {
  try {
    const data = await AppService.rejectApplication(req.params.id, req.user);
    res.json({ success: true, data });
  } catch (err) { next(err); }
}
...
export async function createInterview(req, res, next) {
  try {
    const interview = await AppService.createInterview(req.params.id, req.body, req.user);
...
export async function updateInterview(req, res, next) {
  try {
    const interview = await AppService.updateInterview(req.params.id, req.params.iid, req.body, req.user);
