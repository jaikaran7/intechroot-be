...
router.post('/upsert', authenticate, upload.single('file'), DocumentsController.upsertDocument);
...
router.delete('/:id', authenticate, requireRole('admin', 'super_admin'), DocumentsController.deleteDocument);
