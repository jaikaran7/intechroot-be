...
/** In non-production, allow any localhost / 127.0.0.1 port (Vite may use 5174+ if 5173 is taken). */
...
app.use(cors({
  origin: (origin, callback) => {
    ...
    if (allowedOrigins.includes(origin) || isDevBrowserOrigin(origin)) return callback(null, true);
